 ...
 */
static struct next_hop *nexthop6_create_copy(struct next_hop_v6_u *nhu,
					     int *size)
{
...
static struct next_hop *nextu6_find_path_using_ifp(struct next_hop_v6_u *nhu,
						   struct ifnet *ifp,
						   int *sibling)
{
	uint32_t i;
